...
> engine. See [runtime.md](runtime) for performance and limits.
...
([../packaging/manifest.md](../packaging/manifest)).

## Components

A component is a function returning a view ([../guides/declarative-ui.md](../guides/declarative-ui)).
...
- A curated global set — see [stdlib.md](stdlib). Node.js APIs are not available; use
...
See [../api-reference/conventions.md](../api-reference/conventions).

## Next

- [stdlib.md](stdlib) — built-in globals.
- [runtime.md](runtime) — engine, performance, limits.
- [../guides/interop-c-and-script.md](../guides/interop-c-and-script) — calling C.
