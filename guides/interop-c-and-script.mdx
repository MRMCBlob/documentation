...
([../api-reference/c/ui.md](../api-reference/c/ui)); the declarative model is identical.
...
See [../api-reference/conventions.md](../api-reference/conventions) for memory and
error rules.
...
([../packaging/zap-format.md](../packaging/zap-format)).

## Next

- [../api-reference/c/system.md](../api-reference/c/system)
