...
See [../ui/components/navbar.md](../ui/components/navbar).
...
Each tab has its own navigation stack. See [../ui/components/tabbar.md](../ui/components/tabbar).
...
See [../ui/components/sheet.md](../ui/components/sheet).
...
[../platform/ipc-and-intents.md](../platform/ipc-and-intents).
...
The navigator animates the element between screens. See [animation.md](animation).

## Next

- [../ui/components/navbar.md](../ui/components/navbar)
