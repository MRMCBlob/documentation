...
Test insets with simulator profiles ([../getting-started/simulator.md](../getting-started/simulator)).
...
See [../ui/components/scroll.md](../ui/components/scroll) and
...
See [../ui/components/grid.md](../ui/components/grid).
...
See [../api-reference/c/ui.md](../api-reference/c/ui).
