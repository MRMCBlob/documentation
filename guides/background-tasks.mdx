...
> `zelto.toml` ([../packaging/manifest.md](../packaging/manifest)).
...
| Mode | Use | API |
|---|---|---|
| `audio` | Playback continues in background | [../system-apis/media.md](../system-apis/media) |
| `location` | Continuous location updates | [../system-apis/location.md](../system-apis/location) |
...
([notifications.md](notifications)). Silent server-triggered background refresh is
...
[../platform/app-lifecycle.md](../platform/app-lifecycle). Save state on `pause`;
...
See [../api-reference/c/platform.md](../api-reference/c/platform).
