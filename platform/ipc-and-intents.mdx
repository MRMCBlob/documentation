...
([apk-interop.md](apk-interop)).

## Share targets

Receive content shared from other apps; see [../system-apis/share.md](../system-apis/share).
...
identity ([permissions.md](permissions)).
...
- [apk-interop.md](apk-interop) — Android interop specifics.
- [../guides/navigation.md](../guides/navigation) — routing links to screens.
