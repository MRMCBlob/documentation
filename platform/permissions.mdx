...
In `zelto.toml` ([../packaging/manifest.md](../packaging/manifest)):
...
([../api-reference/c/platform.md](../api-reference/c/platform)).
...
- [../packaging/manifest.md](../packaging/manifest) · [../packaging/signing.md](../packaging/signing)
- [../contributing/services-and-ipc.md](../contributing/services-and-ipc) — the broker.
