...
Or build from source — see [../contributing/build-zelto-os.md](../contributing/build-zelto-os).
...
| Piece | Purpose |
|---|---|
| `zelto` CLI | scaffold, build, run, sign, publish — see [../tooling/cli.md](../tooling/cli) |
| `libzelto` | the C UI toolkit headers + library |
| Zelto Script runtime | the JS-like app runtime ([../zelto-script/runtime.md](../zelto-script/runtime)) |
| Simulator | run apps on your desktop ([simulator.md](simulator)) |

## Next

Build your first app: [hello-world.md](hello-world).
