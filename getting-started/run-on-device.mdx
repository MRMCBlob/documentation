...
> [../contributing/porting-to-a-device.md](../contributing/porting-to-a-device).
...
Logs stream to your terminal; see [../tooling/debugging.md](../tooling/debugging) for
...
- **APK won't install:** the device's Android container may be disabled or unsupported on
  that port — see [../overview/how-it-runs-apks.md](../overview/how-it-runs-apks).
