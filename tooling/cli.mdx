...
and manage devices. Install: [../getting-started/install-sdk.md](../getting-started/install-sdk).
...
See [../packaging/signing.md](../packaging/signing),
[../packaging/publishing.md](../packaging/publishing).
...
See [debugging.md](debugging), [profiling.md](profiling).
