...
| Phase | Hot? Look at |
|---|---|
| Build/diff | Large trees rebuilt too often; memoize, split components ([../guides/state-management.md](../guides/state-management)) |
| Layout | Deep/complex stacks; over-flexing; oversized lists ([../guides/layout.md](../guides/layout)) |
| Paint | Expensive shadows/blur/custom canvas ([../api-reference/c/gfx.md](../api-reference/c/gfx)) |
...
([../guides/interop-c-and-script.md](../guides/interop-c-and-script)).
...
- Use `useAnimatedValue` for continuous/gesture motion so frames don't depend on the JS
  loop ([../guides/animation.md](../guides/animation)).
...
- Stable `key`, cheap `row`, estimated row heights
  ([../ui/components/list.md](../ui/components/list)).
...
Measures cold vs. warm start ([../platform/app-lifecycle.md](../platform/app-lifecycle)).
