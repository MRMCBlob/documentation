...
and applies vsync. Details: [../../contributing/compositor-internals.md](../../contributing/compositor-internals).

## See also

- [ui.md](ui) — built-in components (use these first).
- [../../tooling/profiling.md](../../tooling/profiling) — frame/GPU profiling.
