...
See [../../guides/state-management.md](../../guides/state-management).
...
and `Promise` are available (see [../../zelto-script/stdlib.md](../../zelto-script/stdlib)).
...
([../../tooling/debugging.md](../../tooling/debugging)).
...
| `zelto/ui` | components, modifiers | [ui.md](ui) |
| `zelto/net` | http, websockets | [net.md](net) |
| `zelto/storage` | prefs, files, db, secure | [storage.md](storage) |
| `zelto/notifications` | notifications | [notifications.md](notifications) |
| `zelto/media` | audio/video/images | [media.md](media) |
| `zelto/sensors` | sensors, location | [sensors.md](sensors) |
| `zelto/platform` | lifecycle, permissions, intents | [permissions.md](permissions) |
| `native:<name>` | your C modules | [../../guides/interop-c-and-script.md](../../guides/interop-c-and-script) |
