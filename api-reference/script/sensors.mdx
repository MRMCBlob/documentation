...
[../../system-apis/sensors.md](../../system-apis/sensors),
[../../system-apis/location.md](../../system-apis/location).
...
sensor mocking ([../../getting-started/simulator.md](../../getting-started/simulator)).
...
`always` permission ([../../guides/background-tasks.md](../../guides/background-tasks)).
