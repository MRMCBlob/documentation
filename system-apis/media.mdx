...
[../api-reference/script/media.md](../api-reference/script/media).
...
([../guides/background-tasks.md](../guides/background-tasks)) and shows media controls
in the System UI.
...
- [camera.md](camera) · [../guides/storage.md](../guides/storage)
