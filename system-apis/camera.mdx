...
> Declare `camera = true` in `zelto.toml` ([../packaging/manifest.md](../packaging/manifest));
> the user grants it at runtime ([../platform/permissions.md](../platform/permissions)).
...
See [../overview/how-it-runs-apks.md](../overview/how-it-runs-apks) for hardware
passthrough caveats.

## Output

Captured media is written to app storage and returned as a handle you can read, upload,
or display ([../guides/storage.md](../guides/storage)).
