...
apps surfaced through the APK bridge ([../platform/apk-interop.md](../platform/apk-interop)).
...
([../guides/storage.md](../guides/storage)); copy what you need into app storage, since
the handle may be temporary.

## See also

- [../platform/ipc-and-intents.md](../platform/ipc-and-intents) — deep links & intents.
- [../platform/apk-interop.md](../platform/apk-interop) — sharing with Android apps.
