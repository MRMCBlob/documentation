...
- [how-it-runs-apks.md](how-it-runs-apks)
- [../contributing/compositor-internals.md](../contributing/compositor-internals)
- [../contributing/sdk-internals.md](../contributing/sdk-internals)
- [../platform/permissions.md](../platform/permissions) — security & permission model
