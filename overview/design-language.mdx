...
([../guides/styling-theming.md](../guides/styling-theming)).
...
- **Shared-element transitions** are supported by the navigator (see
  [../guides/navigation.md](../guides/navigation)).

See [../guides/animation.md](../guides/animation) for the animation API.
...
- **Apps** get them for free through `libzelto` defaults and may define an app theme that
  overrides tokens — see [../guides/styling-theming.md](../guides/styling-theming).
