...
[links]                      # deep linking (../platform/ipc-and-intents)
...
- [zap-format.md](zap-format) — how the manifest is packaged.
- [../platform/permissions.md](../platform/permissions) — permission names.
