...
|---|---|---|
| `compositor/` | zcomp | [compositor-internals.md](compositor-internals) |
| `sdk/` | libzelto | [sdk-internals.md](sdk-internals) |
| `script/` | Zelto Script runtime | [../zelto-script/runtime.md](../zelto-script/runtime) |
| `services/` | zsysd, APK bridge | [services-and-ipc.md](services-and-ipc) |
| `system-ui/` | the shell | [../overview/design-language.md](../overview/design-language) |
| `cli/` | `zelto` + simulator | [../tooling/cli.md](../tooling/cli) |
| `device/` | ports | [porting-to-a-device.md](porting-to-a-device) |

## Build system

Meson + Ninja across components; a top-level meson project ties them together. See
[build-zelto-os.md](build-zelto-os).
...
[coding-standards.md](coding-standards). Public SDK headers under `sdk/include/zelto/`
