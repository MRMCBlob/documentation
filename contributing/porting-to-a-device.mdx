...
support. Set expectations accordingly ([../overview/how-it-runs-apks.md](../overview/how-it-runs-apks)).
...
Patch the device kernel config in `device/<device>/` ([repo-layout.md](repo-layout)).
...
`zcomp`. Wire the **APK bridge** ([services-and-ipc.md](services-and-ipc)).
...
- [build-zelto-os.md](build-zelto-os) · [../overview/how-it-runs-apks.md](../overview/how-it-runs-apks)
