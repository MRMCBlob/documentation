...
this (use the prebuilt SDK, [../getting-started/install-sdk.md](../getting-started/install-sdk)).
...
This builds all components ([repo-layout.md](repo-layout)). Build a single component:
...
postmarketOS — see [porting-to-a-device.md](porting-to-a-device).
...
- [porting-to-a-device.md](porting-to-a-device)
