...
- **Wayland protocols** for UI-facing communication (compositor ↔ apps ↔ shell), including
  ...
  ([compositor-internals.md](compositor-internals)).
...
D-Bus directly ([../api-reference/c/platform.md](../api-reference/c/platform)).
...
([../platform/app-lifecycle.md](../platform/app-lifecycle)).
...
([../platform/permissions.md](../platform/permissions)).
...
targets ([../packaging/zap-format.md](../packaging/zap-format),
[../packaging/signing.md](../packaging/signing)).

### App-to-app intents
Brokers typed `intents.request(...)` calls between apps, enforcing identity and
permissions ([../platform/ipc-and-intents.md](../platform/ipc-and-intents)).
...
- **Surface integration:** Android windows are Wayland surfaces; the bridge assigns
  ...
  ([../overview/how-it-runs-apks.md](../overview/how-it-runs-apks)).
...
- **Links/share:** routes deep links and share intents to Android apps
  ([../platform/apk-interop.md](../platform/apk-interop)).
...
([../overview/architecture-overview.md](../overview/architecture-overview)).
...
- [../platform/permissions.md](../platform/permissions) · [compositor-internals.md](compositor-internals)
- [../platform/apk-interop.md](../platform/apk-interop)
